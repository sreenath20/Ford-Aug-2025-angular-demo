...
import { ReactiveFormRegistrationComponent } from '../reactive-form-registration/reactive-form-registration.component';
...
@Component({
  selector: 'app-demo',
  imports: [SortPipe,SearchPipe,SquarePipe,StarPipe,FormsModule,CommonModule,ReactiveFormRegistrationComponent,RegistrationComponent,],
